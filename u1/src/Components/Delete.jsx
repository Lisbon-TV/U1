...
export default function Delete({ setDeleteData, deleteData, setLastUpdate }) {
  const doDestroy = (_) => {
    if (deleteData.money > 0) {
      ...
      alert("There're no funds in the account to delete!");
    }
  };
  return (
      ...
      <div className="modal-dialog modal-dialog-centered">
        <div className="modal-content">
          <div className="modal-header">
            <h5 className="modal-title">Removing the account!</h5>
            <button
              type="button"
              className="btn-close"
          ...
          <div className="modal-body">
            <p>Are you sure you rant to remove this account holder?</p>
          </div>
